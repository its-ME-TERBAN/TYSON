...
TOKEN = '8009416822:AAEWRlHmf0A_mOwje9HUahTQ6WzG0tx8ico'  # Replace with your actual bot token
...
EXEMPTED_USERS = [1604629264, 5047224084]
...
def welcome_start(message):
    ...
    bot.send_message(
            message.chat.id,
            f"👋🏻Welcome {user_name}.\n\n"
            f"[➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](https://t.me/ddosserverfreeze)\n\n"    
    ...
    bot.send_message(
            message.chat.id,
            f"↘️                                                       ↙️\n\n     [➖𝗗𝗠 𝗙𝗢𝗥 𝗥𝗘𝗕𝗥𝗔𝗡𝗗𝗜𝗡𝗚➖](https://t.me/LASTWISHES0)\n\n↗️                                                       ↖️",
    parse_mode="Markdown",
    disable_web_page_preview=True  # This disables the link preview
    )
...
def reset_attack_limit(message):
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [LASTWISHES0](https://t.me/ddosserverfreeze) ⚡*"
    )
...
def bgmi_command(message):
    ...
    try:
        ...
        if user_status not in ["member", "administrator", "creator"]:
            bot.send_message(
                message.chat.id,
                " *‼️TOXIC VIP DDOS™ 𝗔𝗖𝗖𝗘𝗦𝗦 𝗗𝗘𝗡𝗜𝗘𝗗‼️* \n\n"
                "🖤*BHAI PHLE JOIN KAR LE USE KAR NE KE LIYE*🖤\n\n"
                "📢 *LET'S GO AND JOIN CHANNEL*\n"
                f" [➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](buttonurl:https://t.me/TOXIC_APNA_BHAI)\n\n"
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./RAJ {target_ip} {target_port} {default_duration} 1200")
